...
module.exports = router => {
	...
	router.post('/submitClaim', cors(), async function (req, res) {
		...
		console.log("fvgfsahj", claimAmount);
		...
		if (!conditions || !HospitalName.trim() || !status.trim() || !claimAmount) {
			...
			await contractJs.createContract(conditions, HospitalName, submitID, status, claimAmount)
...
// var param1= req.body.params[0];
// param2=req.body.param1;	
//   console.log("params[1]",param1);
//   console.log("params[1]",param2);
//console.log(params)
				var TransactionDetails = {
					"userid": "1",
					"transactionstring": {
						"exp": result1.docs[0].Records,
						"value": [req.body.claimAmount,req.body.DIAGNOSIS],
						"params":["claimAmount","DIAGNOSIS"],
           ...
           await autotpa.autotpa(conditions, HospitalName, submitID, status,claimamount,claimAmount)
